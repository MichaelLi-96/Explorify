  ...
  created = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .put(`${API_URL}/users/update/${this.props.authDetails.user._id}`, updatedUserObj)
          .then((response) => {
    ...
    return (
      <div id="createPlaylistModal">
        ...
        <div id="createPlaylistModalButtonsContainer">
          <div id="createPlaylistModalCancelButton" className="noselect" onClick={this.canceled}>
            Cancel
          </div>
          <div id="createPlaylistModalCreateButton" className="noselect" onClick={this.created}>
            Create
          </div>
        </div>
      </div>
