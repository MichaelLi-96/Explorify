        ...
        .then((response) => {
          ...
          axios
            ...
            .then((response) => {
              ...
              axios
                .post(`${API_URL}/albumPlaylists/add`, {
                  name: 'Liked Songs',
                  isAlbum: false,
                ...
                .then((response) => {
                  ...
                  axios
                    .put(`${API_URL}/users/update/${userId}`, {
                      email: this.state.email.trim(),
                      password: this.state.password,
                      name: this.state.name.trim(),
  ...
  render() {
    return (
      <div id="signUp">
        ...
        <div id="signUpTitle" className="noselect">
          Create an account!
        </div>
        <div id="signUpSubtitle" className="noselect">
          Get access to albums and songs from all your favorite artists.
        </div>
        <div id="signUpFormContainer">
          ...
          <div id="signUpForm">
            ...
            <div id="signUpButton" className="noselect" onClick={this.signUp}>
              Sign Up
            </div>
          </div>
        </div>
        <div id="signUpRegisterContainer">
          <div id="signUpRegisterQuestion" className="noselect">
            Already have an account?
          </div>
          <Link to="/logIn" id="signUpLogIn">
            Log in here
          </Link>
        </div>
      </div>
