  ...
  render() {
    return (
      <div id="logIn">
        ...
        <div id="logInTitle" className="noselect">
          Welcome back!
        </div>
        <div id="logInSubtitle" className="noselect">
          Start listening to all your favorite songs and playlists.
        </div>
        <div id="logInFormContainer">
          ...
          <div id="logInForm">
            ...
            <div id="logInButton" className="noselect" onClick={this.logIn}>
              Log In
            </div>
          </div>
          <div id="logInDivider">
            <div className="logInDividerLine" />
            <div id="logInOr" className="noselect">
              OR
            </div>
            <div className="logInDividerLine" />
          </div>
          <div id="logInDemoButton" className="noselect" onClick={this.demoLogIn}>
            Demo Log In
          </div>
        </div>
        <div id="logInRegisterContainer">
          <div id="logInRegisterQuestion" className="noselect">
            Don't have an account?
          </div>
          <Link to="/signUp" id="logInRegister">
            Register here
          </Link>
        </div>
      </div>
